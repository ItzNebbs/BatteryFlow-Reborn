#import "BFRFirstPopup.h"

@implementation BFRFirstPopup
+ (NSString *)hb_specifierPlist {
	return @"FirstPopup";
}
- (NSMutableArray *)specifiers {
	if (!_specifiers) {
		_specifiers = [self loadSpecifiersFromPlistName:@"FirstPopup" target:self];
...
- (void)testFirstPopup {
	CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(), CFSTR("xyz.itznebbs.batteryflow-reborn/firstpopuptest"), nil, nil, true);
}
@end