#import "BFRFourthPopup.h"

@implementation BFRFourthPopup
+ (NSString *)hb_specifierPlist {
	return @"FourthPopup";
}
- (NSMutableArray *)specifiers {
	if (!_specifiers) {
		_specifiers = [self loadSpecifiersFromPlistName:@"FourthPopup" target:self];
...
- (void)testFourthPopup {
	CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(), CFSTR("xyz.itznebbs.batteryflow-reborn/fourthpopuptest"), nil, nil, true);
}
@end