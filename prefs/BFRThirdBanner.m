#import "BFRThirdBanner.h"

@implementation BFRThirdBanner
+ (NSString *)hb_specifierPlist {
	return @"ThirdBanner";
}
- (NSMutableArray *)specifiers {
	if (!_specifiers) {
		_specifiers = [self loadSpecifiersFromPlistName:@"ThirdBanner" target:self];
...
- (void)testThirdBanner {
	CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(), CFSTR("xyz.itznebbs.batteryflow-reborn/thirdbannertest"), nil, nil, true);
}
@end