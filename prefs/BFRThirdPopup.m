#import "BFRThirdPopup.h"

@implementation BFRThirdPopup
+ (NSString *)hb_specifierPlist {
	return @"ThirdPopup";
}
- (NSMutableArray *)specifiers {
	if (!_specifiers) {
		_specifiers = [self loadSpecifiersFromPlistName:@"ThirdPopup" target:self];
...
- (void)testThirdPopup {
	CFNotificationCenterPostNotification(CFNotificationCenterGetDarwinNotifyCenter(), CFSTR("xyz.itznebbs.batteryflow-reborn/thirdpopuptest"), nil, nil, true);
}
@end